...
-- Criando a Stored Procedure P_ClassificacaoGrupoC --
...
-- Atualizando a Tabela de Classificação Grupo C --
...
-- Atualizando a Classificação Final definindo a posição de cada Seleção no Grupo C --
