...
-- Criando a Stored Procedure P_ClassificacaoGrupoE --
...
-- Atualizando a Tabela de Classificação Grupo E --
...
-- Atualizando a Classificação Final definindo a posição de cada Seleção no Grupo E --
