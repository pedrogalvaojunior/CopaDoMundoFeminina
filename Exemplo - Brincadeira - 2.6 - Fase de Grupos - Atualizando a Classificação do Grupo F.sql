...
-- Criando a Stored Procedure P_ClassificacaoGrupoF -- 
...
-- Atualizando a Tabela de Classificação Grupo F --
...
-- Atualizando a Classificação Final definindo a posição de cada Seleção no Grupo F --
