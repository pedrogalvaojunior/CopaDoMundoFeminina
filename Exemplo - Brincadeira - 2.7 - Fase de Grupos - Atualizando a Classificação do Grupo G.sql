...
-- Criando a Stored Procedure P_ClassificacaoGrupoG --
...
-- Atualizando a Tabela de Classificação Grupo G --
...
-- Atualizando a Classificação Final definindo a posição de cada Seleção no Grupo G --
