...
-- Criando a Stored Procedure P_ClassificacaoGrupoH --
...
-- Atualizando a Tabela de Classificação Grupo H --
...
-- Atualizando a Classificação Final definindo a posição de cada Seleção no Grupo H --
